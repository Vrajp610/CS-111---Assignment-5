...
public class WeatherGenerator {
    ...
    public static int[] oneMonthGenerator(double longitute, double latitude, int month, double[][] drywet, double[][] wetwet) {
        int[] weather = new int[numberOfDaysInMonth[month-2]];
        ...
        double dryNumber = drywet[row][month];
        double wetNmber = wetwet[row][month];
